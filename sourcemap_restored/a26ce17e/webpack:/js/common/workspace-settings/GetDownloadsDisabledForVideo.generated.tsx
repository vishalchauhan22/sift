...
export type DownloadDisabledForVideoQuery = { __typename: 'Query', getVideo: { __typename: 'PrivateVideo' } | { __typename: 'RegularUserVideo', id: string, downloadDisabledForWorkspace: boolean } | { __typename: 'VideoPasswordMissingOrIncorrect' } | null };
