...
export type ConsolidatedEditZoomInstructionsFragment = { __typename: 'RegularUserVideo', id: string, editZoomInstructions: Array<{ __typename: 'EditZoomInstructions', id: string, clipId: string, videoId: string, zoomType: Types.ZoomType, zoomVersion: string, zoomCreatedBy: Types.ZoomCreatedBy, zoomLowerMs: number, zoomUpperMs: number, zoomLevel: number, createdAt: string, updatedAt: string }> };
