...
var Page = /* @__PURE__ */ ((Page2) => {
  ...
  Page2["MigrationActive"] = "migration-active";
...
const Team = {
   ...
   * Route any questions to #team-eng-chat
   */
  ...
  MeetingRecording: teamInfoHelper(
    "MeetingRecording",
    "C07K6KSGHM1",
    // loom-eng-meeting-recordings
    "@loomhq/meeting-recording"
  ),
  Mint: teamInfoHelper(
...
const Feature = {
  ...
  Acl: feat(FeatureNames.Acl, Team.IntegrationExperience),
  ActivityResponseRepository: feat(
    FeatureNames.ActivityResponseRepository,
  ...
  AdminDevToolsRbac: feat(
    FeatureNames.AdminDevToolsRbac,
    Team.DeveloperExperience
  ),
  AdminLoombaChat: feat(FeatureNames.AdminLoombaChat, Team.ShareAndTransform),
  ...
  Braintrust: feat(FeatureNames.Braintrust, Team.ShareAndTransform),
  BusinessTrial: feat(FeatureNames.BusinessTrial, Team.Outreach),
  CSAM: feat(FeatureNames.CSAM, Team.Mint),
  CalendarMeetings: feat(FeatureNames.CalendarMeetings, Team.MeetingRecording),
  Calendly: feat(FeatureNames.Calendly, Team.IntegrationExperience),
  CameraBubble: feat(FeatureNames.CameraBubble, Team.Capture),
  CameraBubblePicker: feat(
    FeatureNames.CameraBubblePicker,
    Team.ShareAndTransform
  ),
  CameraFrames: feat(FeatureNames.CameraFrames, Team.Capture),
  Canvas: feat(FeatureNames.Canvas, Team.RecordingClients),
  ...
  CommentPostService: feat(
    FeatureNames.CommentPostService,
    Team.ShareAndTransform
  ),
  CommentPostServiceInternal: feat(
    FeatureNames.CommentPostServiceInternal,
    Team.ShareAndTransform
  ),
  CommentReactionRepository: feat(
    FeatureNames.CommentReactionRepository,
    Team.ShareAndTransform
  ),
  CommentReactionService: feat(
    FeatureNames.CommentReactionService,
    Team.ShareAndTransform
  ),
  CommentReactions: feat(FeatureNames.CommentReactions, Team.ShareAndTransform),
  CommentReplyService: feat(
    FeatureNames.CommentReplyService,
    Team.ShareAndTransform
  ),
  CommentReplyServiceInternal: feat(
    FeatureNames.CommentReplyServiceInternal,
    Team.ShareAndTransform
  ),
  Comments: feat(FeatureNames.Comments, Team.ShareAndTransform),
  Composer: feat(FeatureNames.Composer, Team.EnterpriseReadiness),
  ...
  ContactSync: feat(FeatureNames.ContactSync, Team.IntegrationExperience),
  ContentExport: feat(FeatureNames.ContentExport, Team.Undetermined),
  CopyLinkSection: feat(
    FeatureNames.CopyLinkSection,
    Team.IntegrateOrganizeCollaborate
  ),
  CpusAgent: feat(FeatureNames.CpusAgent, Team.Identity),
  CreateTestData: feat(FeatureNames.CreateTestData, Team.Billing),
  CsmAiAgent: feat(FeatureNames.CsmAiAgent, Team.Acquisition),
  ...
  DesktopMeetingSurface: feat(
    FeatureNames.DesktopMeetingNotesSurface,
    Team.MeetingRecording
  ),
  ...
  DeveloperContext: feat(FeatureNames.DeveloperContext, Team.AsyncWorkflows),
  DeveloperPortal: feat(FeatureNames.DeveloperPortal, Team.Capture),
  DigitalWallets: feat(FeatureNames.DigitalWallets, Team.Billing),
  ...
  EmbedSpaces: feat(FeatureNames.EmbedSpaces, Team.EnterpriseReadiness),
  ...
  FeatureFlags: feat(FeatureNames.FeatureFlags, Team.Activation),
  FeatureWrapper: feat(FeatureNames.FeatureWrapper, Team.CorePlatform),
  FolderRepository: feat(
    FeatureNames.FolderRepository,
    Team.EnterpriseReadiness
  ),
  Folders: feat(FeatureNames.Folders, Team.EnterpriseReadiness),
  FollowRepository: feat(FeatureNames.FollowRepository, Team.Outreach),
  ...
  GlobalAdminEditPanel: feat(
    FeatureNames.GlobalAdminEditPanel,
    Team.EnterpriseReadiness
  ),
  ...
  GroupingRepository: feat(
    FeatureNames.GroupingRepository,
    Team.IntegrateOrganizeCollaborate
  ),
  ...
  Integrations: feat(FeatureNames.Integrations, Team.IntegrationExperience),
  Intercom: feat(FeatureNames.Intercom, Team.IntegrationExperience),
  ...
  Jira1pIntegration: feat(FeatureNames.Jira1pIntegration, Team.AsyncWorkflows),
  ...
  LiveTranscripts: feat(FeatureNames.LiveTranscripts, Team.MeetingRecording),
  ...
  LoomTransform: feat(FeatureNames.LoomTransform, Team.IntegrationExperience),
  ...
  MeetingAiAgent: feat(FeatureNames.MeetingAiAgent, Team.Mint),
  ...
  MeetingRecordingFtux: feat(
    FeatureNames.MeetingRecordingFtux,
    Team.MeetingRecording
  ),
  ...
  NotificationSettings: feat(FeatureNames.NotificationSettings, Team.Outreach),
  Notifications: feat(FeatureNames.Notifications, Team.Outreach),
  ObjectProviderService: feat(
    FeatureNames.ObjectProviderService,
    Team.EnterpriseReadiness
  ),
  ObjectStoreService: feat(FeatureNames.ObjectStoreService, Team.Mint),
  OnDemandMP4: feat(FeatureNames.OnDemandMP4, Team.Mint),
  Onboarding: feat(FeatureNames.Onboarding, Team.Outreach),
  OutboxGlobalDeletionConsumer: feat(
    FeatureNames.OutboxGlobalDeletionConsumer,
    Team.EnterpriseReadiness
  ),
  OutboxGlobalRepository: feat(
    FeatureNames.OutboxGlobalRepository,
    Team.EnterpriseReadiness
  ),
  OutboxShardDeletionConsumer: feat(
    FeatureNames.OutboxShardDeletionConsumer,
    Team.EnterpriseReadiness
  ),
  OutboxShardRepository: feat(
    FeatureNames.OutboxShardRepository,
    Team.EnterpriseReadiness
  ),
  ...
  PdeWorkflows: feat(FeatureNames.PdeWorkflows, Team.AsyncWorkflows),
  ...
  RecapTab: feat(FeatureNames.RecapTab, Team.MeetingRecording),
  ...
  RovoChatAgent: feat(FeatureNames.RovoChatAgent, Team.EnterpriseReadiness),
  RovoVideoBackfill: feat(
    FeatureNames.RovoVideoBackfill,
    Team.IntegrationExperience
  ),
  SDKRecorder: feat(FeatureNames.SDKRecorder, Team.Capture),
  SFDC: feat(FeatureNames.SFDC, Team.IntegrationExperience),
  ...
  ShareModal: feat(FeatureNames.ShareModal, Team.ShareAndTransform),
  ...
  SharePage: feat(FeatureNames.SharePage, Team.ShareAndTransform),
  ...
  Slack: feat(FeatureNames.Slack, Team.IntegrationExperience),
  SlackBacklinks: feat(FeatureNames.SlackBacklinks, Team.IntegrationExperience),
  ...
  SpaceRepository: feat(FeatureNames.SpaceRepository, Team.EnterpriseReadiness),
  Spaces: feat(FeatureNames.Spaces, Team.EnterpriseReadiness),
  ...
  Tagging: feat(FeatureNames.Tagging, Team.EnterpriseReadiness),
  ...
  TransactionalOutbox: feat(
    FeatureNames.TransactionalOutbox,
    Team.EnterpriseReadiness
  ),
  ...
  TrelloAgent: feat(FeatureNames.TrelloAgent, Team.Undetermined),
  TrelloIntegration: feat(FeatureNames.TrelloIntegration, Team.Undetermined),
  TrendingLooms: feat(
  ...
  Variables: feat(FeatureNames.Variables, Team.ShareAndTransform),
  VideoArchival: feat(FeatureNames.VideoArchival, Team.ShareAndTransform),
  VideoAttachmentRepository: feat(
    FeatureNames.VideoAttachmentRepository,
    Team.EnterpriseReadiness
  ),
  VideoBackground: feat(FeatureNames.VideoBackground, Team.ShareAndTransform),
  VideoChaptersRepository: feat(
    FeatureNames.VideoChaptersRepository,
    Team.ShareAndTransform
  ),
  ...
  VideoSpeakers: feat(FeatureNames.VideoSpeakers, Team.MeetingRecording),
  ...
  Zoom: feat(FeatureNames.Zoom, Team.IntegrationExperience)
};
