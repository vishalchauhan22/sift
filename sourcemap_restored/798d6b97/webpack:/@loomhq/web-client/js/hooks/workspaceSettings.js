...
export const useWorkspaceSetting = (
  ...
  const { loading, error, data, refetch } = useGetWorkspaceSettingQuery({
    ...options,
    variables: { settingName, includeTimestamps },
    onError: err => {
  ...
  if (includeTimestamps) {
    result.timestamps = {
      createdAt: data?.getWorkspaceSetting?.createdAt,
      updatedAt: data?.getWorkspaceSetting?.updatedAt,
    };
  }
