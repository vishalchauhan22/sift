...
const EXPERIMENTS = {
  ...
  EXP_VISUAL_REFRESH_ON_ANON_SHARE_PAGE_GATE_V2: "exp-visual-refresh-on-anon-share-page-gate-v2",
  ...
  CAM_SPLIT_WITH_AUTO_ZOOM_AND_LOCATION_PICKER: "loom_cam_split_with_auto_zoom_and_location_picker",
...
const FEATURE_GATES = {
  ...
  LOOM_DEPRECATE_OLD_TRANSCRIPTS_ARCHITECTURE: "loom-deprecate-old-transcripts-architecture",
  ...
  LOOM_ROLLOUT_INLINE_COMMENT_REACTIONS: "loom-rollout-inline-comment-reactions",
  LOOM_ENABLE_PRIMARY_SPACE_NOTIFICATIONS: "loom-enable-primary-space-notifications",
  ...
  MEETING_RECORDINGS_SEND_EMAIL_ON_REGENERATION: "meeting-recordings-send-email-on-regeneration",
  ...
  MEETING_RECORDING_LIVE_MEETING_AGENT_FEATURES: "mr-live-meeting-agent-features",
  ...
  LOOM_ADD_PRIORITY_FIELD_TO_CONTACT_FORM: "loom_add_priority_field_to_contact_form",
  ...
  LOOM_MP4_REGENERATION_FROM_PLAYER_ENABLED: "loom-mp4-regeneration-from-player-enabled",
  TRANSLATED_CAPTIONS_CHUNKING: "translated-captions-chunking",
  LOOM_AMN_POST_MEETING_RECAP_GENERATION_GATE: "loom-amn-post-meeting-recap-generation-gate",
  LOOM_EDITIONS_AWARENESS_BUTTON: "loom-ea-eu-25",
  LOOM_AMN_POST_MEETING_RECAP_GENERATION_BUG_FIXES: "loom-amn-post-meeting-recap-generation-bug-fixes"
};
const DYNAMIC_CONFIGS = {
  ...
  LOOM_BRAINTRUST_SAMPLE_RATE_AVATARS_OVERLAYS: "loom-braintrust-sample-rate-avatars-overlays",
  LOOM_BRAINTRUST_SAMPLE_RATE_AVATARS_SCRIPTS: "loom-braintrust-sample-rate-avatars-scripts",
  LOOM_SEARCH_BACKFILL_QUEUE_CONFIGURATION: "loom-search-backfill-queue-configuration",
...
var FlagReturnValues = /* @__PURE__ */ ((FlagReturnValues2) => {
  ...
  FlagReturnValues2["VARIANT_EXCLUDED"] = "variant-excluded";
  FlagReturnValues2["DUMMY_CONTROL"] = "dummy-control";
  FlagReturnValues2["DUMMY_VARIANT"] = "dummy-variant";
