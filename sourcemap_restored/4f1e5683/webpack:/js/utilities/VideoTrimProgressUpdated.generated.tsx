...
export type VideoTrimProgressUpdatedSubscription = { __typename: 'Subscription', videoTrimProgressUpdated: { __typename: 'VideoTrimProgress', progress: number | null } | null };
