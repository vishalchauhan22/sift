...
export type GetWorkspaceAggEntitlementsQuery = { __typename: 'Query', getWorkspaceAGGEntitlements: { __typename: 'AggTokenRefreshError', message: string } | { __typename: 'GenericError', message: string } | { __typename: 'GetWorkspaceAGGEntitlementsPayload', entitlements: Array<{ __typename: 'Entitlement', orgId: string, entitlementId: string, offeringId: string, sku: string, productKey: string, pricingType: string, offeringName: string, currentLoomProductLevel: number, trialing: boolean, autoConverting: boolean, timeLeft: number, isCollection: boolean } | null> } | { __typename: 'InputValidationError' } | { __typename: 'UserNotAuthorizedError' } | null };
