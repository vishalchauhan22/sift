...
import {
  ...
  TRANSCRIPTION_EXPECTED_UNSUCCESSFUL_STATUSES
...
const isExpectedUnsuccessfulTranscriptionStatus = makeStatusCheckFunction(TRANSCRIPTION_EXPECTED_UNSUCCESSFUL_STATUSES);
