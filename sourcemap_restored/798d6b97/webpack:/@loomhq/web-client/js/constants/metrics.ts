...
export const ASG_SOCIAL_BUTTON_CLICKED = 'asg.social.button.clicked';

// Gating Modals
export const GATING_MODAL_OPENED = 'loom.web.gating.modal.opened';
...
// Uppy
export const ASSET_UPLOAD_START = 'uppy.asset_upload.start';
export const ASSET_UPLOAD_SUCCESS = 'uppy.asset_upload.success';
export const ASSET_UPLOAD_ERROR = 'uppy.asset_upload.error';

// Live transcripts
export const LIVE_TRANSCRIPT_SUCCESS = 'live_transcript.success';
export const LIVE_TRANSCRIPT_FATAL = 'live_transcript.fatal';
