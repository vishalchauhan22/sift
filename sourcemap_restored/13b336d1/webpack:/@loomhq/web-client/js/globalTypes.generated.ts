...
export type GetContentExportsResponse = GenericError | GetContentExportsPayload | UserNotAuthorizedError;
...
export type GetPublishedOrMostRecentVideoDocumentForEditorPayload = {
  ...
  /** The published or most recent video document for the editor, or null if none exists */
...
export type InitiateContentExportInput = {
  userId: Scalars['ID']['input'];
  workspaceGuid: Scalars['ID']['input'];
};

export type InitiateContentExportResponse = GenericError | InitiateContentExportSuccessPayload | UserNotAuthorizedError;
...
export type MutationInitiateContentExportArgs = {
  input: InitiateContentExportInput;
};
...
export type Query = {
  ...
  /** Get the published or most recent video document for an editor. Returns published documents first (ordered by dateVisibleToViewers), then falls back to most recently updated unpublished document. */
...
export type ScreenshotWithCredentialsUnion = ScreenshotWithS3Credentials | ScreenshotWithTdpOsCredentials;
