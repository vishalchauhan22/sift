...
const ROLLOUT_LOOM_SCOPES_REFACTORING = "rollout-loom-scopes-refactoring";
const SHUTOFF_STRIPE_RATE_LIMIT = "shutoff-stripe-rate-limit";
const ROLLOUT_PRICING_BACKFILL = "rollout-pricing-backfill";
const EXP_DOWNLOAD_GATING = "exp-download-gating";
...
const GOOGLE_CONTACTS_SYNC_PAGE_LIMIT = (
  // migrated
  "google-contacts-sync-page-limit"
);
const GOOGLE_CONTACTS_SYNC_PARALLELIZE_PAGESYNC = (
  // migrated
  "google-contacts-sync-parallelize-pagesync"
);
...
const ROLLOUT_HIDE_VIEWER_ROLE = "rollout-hide-viewer-role";
...
const TRANSCODER_VIDEO_UPLOAD_REFACTOR = "transcoder-video-upload-refactor";
...
const EXP_MOBILE_WEB_ONBOARDING_V2 = "exp-mobile-web-onboarding";
...
const SHAKA_RESPONSE_LOGGING = "rollout-shaka-response-logging";
...
const STATSIG_MIGRATION_FLAGS_OBJ = {
  ...
  [GOOGLE_CONTACTS_SYNC_PAGE_LIMIT]: {
    team: Team.Outreach,
    useNewResult: true,
    statsigLink: "https://console.statsig.com/experiments/google-contacts-sync-page-limit"
  },
  ...
  [GOOGLE_CONTACTS_SYNC_PARALLELIZE_PAGESYNC]: {
    team: Team.CorePlatform,
    newControlType: ControlType.STATSIG_FEATURE_GATE,
    useNewResult: true,
    statsigLink: "https://console.statsig.com/gates/google-contacts-sync-parallelize-pagesync"
  },
  ...
  [ROLLOUT_HIDE_VIEWER_ROLE]: {
    ...
    newControlType: ControlType.STATSIG_FEATURE_GATE,
    useNewResult: true,
    statsigLink: "https://console.statsig.com/gates/rollout-hide-viewer-role"
  },
  ...
  [EXP_DOWNLOAD_GATING]: {
    team: Team.Outreach,
    useNewResult: true,
    statsigLink: "https://console.statsig.com/experiments/exp-download-gating"
  },
  ...
  [SHAKA_RESPONSE_LOGGING]: {
    ...
    useNewResult: true,
    newControlType: ControlType.STATSIG_FEATURE_GATE,
    statsigLink: "https://console.statsig.com/gates/rollout-shaka-response-logging"
  }
};
export {
  ACTIVE,
  ...
  ROLLOUT_LOG_MOBILE_ACTIVE_USER_EVENT,
  ROLLOUT_LOOM_QUANTITY_SMART_SYNC,
  ROLLOUT_LOOM_SCOPES_REFACTORING,
  ...
  TRANSCODER_VIDEO_UPLOAD_REFACTOR,
  ULTRAFAST_4K_ENCODING,
  UPGRADE_GPT_MODEL_FOR_TRANSCRIPT_BASED_AI,
  VARIANT,
  VARIANT_AND_ACTIVE,
