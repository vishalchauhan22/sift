...
import { CameraPickerRegion } from '@js/globalTypes.generated';
...
export const EDIT_BACKGROUND_UPLOADED = 'Edit Background Uploaded';

export const fireEditBackgroundUploadedEvent = ({
  videoId,
  assetId,
  fileSize,
  status,
  ...
  analytics.track(EDIT_BACKGROUND_UPLOADED, {
    ...withIdentifiers(
      EDIT_BACKGROUND_UPLOADED,
      AnalyticsEntityId.video(videoId, 'videoId'),
      AnalyticsEntityId.asset(assetId, 'assetId')
    ),
    fileSize,
    status,
  });
...
export const EDIT_BACKGROUND_DELETED = 'Edit Background Deleted';

export const fireEditBackgroundDeletedEvent = ({
  videoId,
  assetId,
}: {
  videoId: string;
  ...
  analytics.track(EDIT_BACKGROUND_DELETED, {
    ...withIdentifiers(
      EDIT_BACKGROUND_DELETED,
      AnalyticsEntityId.video(videoId, 'videoId'),
      AnalyticsEntityId.asset(assetId, 'assetId')
    ),
  });
...
export const fireEditTtsReachLengthLimitEvent = ({
  videoId,
  attemptedSyllableCount,
  type,
}: {
  videoId: string;
  attemptedSyllableCount: number;
  type: 'ceiling' | 'floor';
}): void => {
...
export const fireEditTtsClickReplaceEvent = ({
  ...
  replacingSyllableCount,
}: {
  videoId: string;
  originalSyllableCount: number;
  replacingSyllableCount: number;
}): void => {
...
export const CONSOLIDATED_EDIT_TTS_MODAL_FTUX_DISMISS =
  'Consolidated Edit TTS Modal Ftux Dismiss';

export const fireEditTtsModalFtuxDismissEvent = ({
  videoId,
}: {
  videoId: string;
}): void => {
  analytics.track(
    CONSOLIDATED_EDIT_TTS_MODAL_FTUX_DISMISS,
    withIdentifiers(
      CONSOLIDATED_EDIT_TTS_MODAL_FTUX_DISMISS,
      AnalyticsEntityId.video(videoId, 'videoId')
    )
...
export const CONSOLIDATED_EDIT_TTS_MODAL_FTUX_DISPLAYED =
  'Consolidated Edit TTS Modal Ftux Displayed';

export const fireEditTtsModalFtuxDisplayedEvent = ({
  videoId,
}: {
  videoId: string;
}): void => {
  analytics.track(
    CONSOLIDATED_EDIT_TTS_MODAL_FTUX_DISPLAYED,
    withIdentifiers(
      CONSOLIDATED_EDIT_TTS_MODAL_FTUX_DISPLAYED,
      AnalyticsEntityId.video(videoId, 'videoId')
    )
...
export const EDIT_POSITION_CAMERA_CLICKED = 'Edit Position Camera Clicked';

export const fireEditPositionCameraClickedEvent = ({
  videoId,
}: {
  videoId: string;
}): void => {
  analytics.track(EDIT_POSITION_CAMERA_CLICKED, {
    ...withIdentifiers(
      EDIT_POSITION_CAMERA_CLICKED,
      AnalyticsEntityId.video(videoId, 'videoId')
    ),
    source: 'consolidated_editor',
  });
...
export const EDIT_POSITION_CAMERA_LOCATION_PICKED =
  'Edit Postion Camera Location Picked';

export const fireEditPositionCameraLocationPickedEvent = ({
  videoId,
  location,
}: {
  videoId: string;
  location: CameraPickerRegion;
}): void => {
  analytics.track(EDIT_POSITION_CAMERA_LOCATION_PICKED, {
    ...withIdentifiers(
      EDIT_POSITION_CAMERA_LOCATION_PICKED,
      AnalyticsEntityId.video(videoId, 'videoId')
    ),
    source: 'consolidated_editor',
    location,
...
export const EDIT_ZOOM_INSTRUCTIONS_ADD_ZOOMS_CLICKED =
  'Edit Zooms Click Add Zooms';

export const fireAddZoomsClickedEvent = ({
  videoId,
  originalautoZoomCount,
}: {
  videoId: string;
  originalautoZoomCount: number;
}): void => {
  analytics.track(EDIT_ZOOM_INSTRUCTIONS_ADD_ZOOMS_CLICKED, {
    ...withIdentifiers(
      EDIT_ZOOM_INSTRUCTIONS_ADD_ZOOMS_CLICKED,
      AnalyticsEntityId.video(videoId, 'videoId')
    ),
    originalautoZoomCount,
  });
...
export const EDIT_ZOOM_INSTRUCTIONS_AUTO_ZOOM_TOGGLED =
  'Edit Zooms Toggle Auto Zoom';

export const fireAutoZoomToggledEvent = ({
  videoId,
  source,
  enabled,
}: {
  ...
  analytics.track(EDIT_ZOOM_INSTRUCTIONS_AUTO_ZOOM_TOGGLED, {
    ...withIdentifiers(
      EDIT_ZOOM_INSTRUCTIONS_AUTO_ZOOM_TOGGLED,
      AnalyticsEntityId.video(videoId, 'videoId')
    ),
    source,
    enabled,
...
export const EDIT_ZOOM_INSTRUCTIONS_DELETE_ZOOM_CLICKED =
  'Edit Zooms Click Delete Zoom';

export const fireDeleteZoomClickedEvent = ({
  videoId,
}: {
  videoId: string;
}): void => {
  analytics.track(EDIT_ZOOM_INSTRUCTIONS_DELETE_ZOOM_CLICKED, {
    ...withIdentifiers(
      EDIT_ZOOM_INSTRUCTIONS_DELETE_ZOOM_CLICKED,
      AnalyticsEntityId.video(videoId, 'videoId')
    ),
  });
};

export const EDIT_ZOOM_INSTRUCTIONS_HIDE_WAVEFORM_ZOOM_TOGGLED =
  'Edit Hide Waveform Zoom Toggled';

export const fireHideWaveformZoomToggledEvent = ({
  videoId,
  toggle,
}: {
  videoId: string;
  ...
  analytics.track(EDIT_ZOOM_INSTRUCTIONS_HIDE_WAVEFORM_ZOOM_TOGGLED, {
    ...withIdentifiers(
      EDIT_ZOOM_INSTRUCTIONS_HIDE_WAVEFORM_ZOOM_TOGGLED,
      AnalyticsEntityId.video(videoId, 'videoId')
    ),
    toggle,
  });
...
export const EDIT_ZOOM_INSTRUCTIONS_HIDE_WAVEFORM_OVERLAY_TOGGLED =
  'Edit Hide Waveform Overlay Toggled';

export const fireHideWaveformOverlayToggledEvent = ({
  videoId,
  toggle,
}: {
  videoId: string;
  ...
  analytics.track(EDIT_ZOOM_INSTRUCTIONS_HIDE_WAVEFORM_OVERLAY_TOGGLED, {
    ...withIdentifiers(
      EDIT_ZOOM_INSTRUCTIONS_HIDE_WAVEFORM_OVERLAY_TOGGLED,
      AnalyticsEntityId.video(videoId, 'videoId')
    ),
    toggle,
  });
