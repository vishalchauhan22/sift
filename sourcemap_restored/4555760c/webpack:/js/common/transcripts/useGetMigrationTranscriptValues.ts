...
import { useNewArchFlagEnabled } from './useNewArchFlagEnabled';
...
export const useGetMigrationTranscriptValues =
  (): UseGetMigrationTranscriptValuesReturnValue => {
    ...
    const transcriptUsingNewArch = isNewTranscriptArchitecture(transcript);
    const newArchFlagEnabled = useNewArchFlagEnabled();
    const newTranscriptArchitecture =
      transcriptUsingNewArch && newArchFlagEnabled;
