...
export const persistAnonActivityDataPreAuth = (
  ...
  try {
    ...
    anonActivityData.anonRedirect = anonActivityData['redirect_after'];
...
type loginHandlerParams = {
  ...
  videoId?: string;
  redirectUri?: string;
  idacCallbackParams?: Record<string, string>;
          ...
          if (redirectUri) {
            ...
            if (targetUrl.hostname.endsWith('atlassian.com')) {
              ...
              if (
                ...
                persistAnonActivityDataPreAuth(
                  idacCallbackParams as AnonActivityParams
                );
