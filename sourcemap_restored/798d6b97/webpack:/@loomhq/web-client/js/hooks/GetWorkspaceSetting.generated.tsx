...
export type GetWorkspaceSettingQueryVariables = Types.Exact<{
  ...
  includeTimestamps?: Types.InputMaybe<Types.Scalars['Boolean']['input']>;
}>;


export type GetWorkspaceSettingQuery = { __typename: 'Query', getWorkspaceSetting: { __typename: 'GenericError' } | { __typename: 'InputValidationError' } | { __typename: 'Setting', id: string | null, createdAt?: string | null, updatedAt?: string | null, setting: { __typename: 'BooleanObject', id: string | null, booleanValue: boolean | null } | { __typename: 'IntObject', id: string | null, intValue: number | null } | { __typename: 'JSONObject', id: string | null, jsonValue: unknown | null } | { __typename: 'StringObject', id: string | null, stringValue: string | null } | null } | { __typename: 'UserNotAuthorizedError' } | null };


export const GetWorkspaceSettingDocument = gql`
    query GetWorkspaceSetting($settingName: String!, $includeTimestamps: Boolean = false) {
  getWorkspaceSetting(
    ...
    ... on Setting {
      ...
      createdAt @include(if: $includeTimestamps)
      updatedAt @include(if: $includeTimestamps)
    }
  }
}
    `;
 ...
 *      includeTimestamps: // value for 'includeTimestamps'
 *   },
 * });
 */
