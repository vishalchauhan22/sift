...
> = props => {
  ...
  return (
    ...
    >
      <div
        className="workify__navigationBar__wrapper"
        style={
          useMarketingBrand
            ? { paddingLeft: '40px', paddingRight: '40px', paddingTop: '32px' }
            : {}
        }
      >
        <DownloadProgress />
        <Logo
          ...
          maxWidth={useMarketingBrand ? 16 : 12}
          brand={useMarketingBrand ? 'marketing' : 'loom'}
        />
