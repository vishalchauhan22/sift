...
export type GetMeetingNotesPageQuery = { __typename: 'Query', getVideo: { __typename: 'PrivateVideo' } | { __typename: 'RegularUserVideo', id: string, meetingNotesPage: { __typename: 'MeetingNotesPage', pageUrl: string } | null } | { __typename: 'VideoPasswordMissingOrIncorrect' } | null };
