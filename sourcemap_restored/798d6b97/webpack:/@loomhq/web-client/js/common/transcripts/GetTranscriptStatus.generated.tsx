...
export type GetTranscriptStatusQuery = { __typename: 'Query', fetchVideoTranscript: { __typename: 'GenericError', message: string } | { __typename: 'InvalidRequestWarning', message: string } | { __typename: 'VideoTranscriptDetails', idv2: string, video_id: string, transcription_status: Types.TranscriptionStatuses } };
