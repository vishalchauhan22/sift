...
export type FetchVideoReactionsQuery = { __typename: 'Query', videoReactionsForVideo: { __typename: 'GenericError', message: string } | { __typename: 'InvalidRequestWarning', message: string } | { __typename: 'VideoReactionsSuccessPayload', reactions: Array<{ __typename: 'PublicVideoReaction', id: string, time: number, reaction: number, extended_reaction: string | null, anon_user_id: string | null, anon_user_name: string | null, locallyCreated: boolean | null, localId: string | null, user: { __typename: 'RegularUser', id: string, display_name: string } | null }> | null } };
