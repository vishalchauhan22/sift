...
export type GetCalendarMeetingsQuery = { __typename: 'Query', me: { __typename: 'RegularUser', id: string, botProactivePromptingEnabled: boolean | null, meetingRecordingSettings: { __typename: 'MeetingRecordingSettings', guid: string, recordingLinkSharing: Types.MeetingRecordingLinkSharingType, recordingWorkspaceMemberAccess: Types.MeetingRecordingAccessType, recordingSummaryNotificationSetting: Types.MeetingRecordingSummaryNotificationType, autoRecordOwnedMeetings: Types.AutoRecordOwnedMeetingsType } | null, calendars: Array<{ __typename: 'CalendarInfo', guid: string, integrationType: Types.ConnectedServiceIntegrationEnumType, lastSyncedAt: string | null, emailDomains: Array<string>, meetings: Array<{ __typename: 'CalendarMeeting', id: string, calendarMeetingGuid: string, title: string | null, description: string | null, platform: string | null, url: string | null, code: string | null, organizerEmail: string | null, startTime: string | null, durationMins: number | null, createdAt: string | null, updatedAt: string | null, recurring: boolean | null, hasExternalParticipants: boolean, automationsOverridden: boolean, owned: boolean, record: boolean, past: boolean, videoId: string | null, recordingLinkSharing: Types.MeetingRecordingLinkSharingType, recordingWorkspaceMemberAccess: Types.MeetingRecordingAccessType, recordingSummaryNotificationSetting: Types.MeetingRecordingSummaryNotificationType, calendarMeetingId: string, organizer: { __typename: 'RegularUser', id: string, first_name: string | null, last_name: string | null, email: string, avatars: Array<{ __typename: 'Avatar', thumb: string }> } | null, recorder: { __typename: 'RegularUser', id: string, first_name: string | null, last_name: string | null, email: string, avatars: Array<{ __typename: 'Avatar', thumb: string }> } | null, recordingFolders: Array<{ __typename: 'RegularUserFolder', id: string, name: string, space: { __typename: 'Space', id: string } | null } | null> | null, recordingSpaces: Array<{ __typename: 'Space', id: string, name: string } | null> | null } | null> }> } | null };
