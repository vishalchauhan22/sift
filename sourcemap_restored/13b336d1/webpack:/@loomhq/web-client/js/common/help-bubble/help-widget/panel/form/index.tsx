...
export const Form = ({
  ...
  const isPriorityFieldEnabled = useFlagIsActivated({
    flag: FEATURE_GATES.LOOM_ADD_PRIORITY_FIELD_TO_CONTACT_FORM,
      ...
      setIsValid(
        Boolean(
          isNonEmptyString(category) &&
            ...
            (!isPriorityFieldEnabled || isNonEmptyString(priority))
        )
      );
    } else if (
      ...
      <Arrange gap={3} autoFlow="row">
        ...
        {isPriorityFieldEnabled &&
          ...
          category === TICKET_CATEGORIES.TECHNICAL && (
            <FormField
              labelFor="priorityFormField"
              label={
                <Arrange gap="xsmall" id="priorityQuestion">
            ...
            >
              <Spacer top={1} />
              <Select
                id="priorityFormField"
                aria-labelledby="priorityFormField priorityQuestion"
                placeholder="Select option"
                selectedOptionValue={priority}
