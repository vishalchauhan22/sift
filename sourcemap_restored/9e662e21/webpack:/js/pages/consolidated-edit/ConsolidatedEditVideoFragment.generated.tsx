...
export type ConsolidatedEditZoomInstructionsFragment = { __typename: 'RegularUserVideo', id: string, supportsEditZoomInstructions: boolean, editZoomInstructions: Array<{ __typename: 'EditZoomInstructionsMetadata', id: string, zoomCreatedBy: Types.ZoomCreatedBy, lowerMs: number, upperMs: number }> };
