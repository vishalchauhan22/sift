...
export const initForVideo = (id: string): void => {
  videoId = id;
};

export const trackModal = (videoId: string): void =>
  analytics.track(
    EI_MODAL_VIEWS_OPEN,
    withIdentifiers(
      EI_MODAL_VIEWS_OPEN,
...
export const trackActivate = (): void =>
  analytics.track(
    EI_SEE_ENGAGEMENTS_CLICKED,
    withIdentifiers(
      EI_SEE_ENGAGEMENTS_CLICKED,
...
export const trackPartialInfoAck = (): void =>
  analytics.track(
    EI_PARTIAL_INFO_ACK,
    withIdentifiers(
      EI_PARTIAL_INFO_ACK,
...
export const trackBackToList = (): void =>
  analytics.track(
    EI_BACK_TO_LIST_CLICKED,
    withIdentifiers(
      EI_BACK_TO_LIST_CLICKED,
...
export const trackViewerDetails = (): void =>
  analytics.track(
    EI_VIEWER_DETAILS_CLICKED,
    withIdentifiers(
      EI_VIEWER_DETAILS_CLICKED,
...
export const trackInfoIcon = (source = {}): void =>
...
export const trackInfoLink = (): void =>
  analytics.track(
    EI_INFO_LINK_CLICKED,
    withIdentifiers(
      EI_INFO_LINK_CLICKED,
