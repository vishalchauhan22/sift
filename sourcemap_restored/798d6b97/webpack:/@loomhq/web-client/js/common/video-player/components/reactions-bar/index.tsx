...
export const ReactionsBar = ({
  ...
  return (
    <ReactionsBarWrapper hasStarted={hasStarted}>
      {reactionsEnabled ? (
        <>
          <SuccessMarker name={SuccessMarkers.PlayerReactionsLoaded} />
        ...
        // This will shortcut the success marker for reactions if they are not enabled
        <SuccessMarker name={SuccessMarkers.PlayerReactionsLoaded} />
      )}
      ...
      {commentsEnabled ? (
        <>
          <SuccessMarker name={SuccessMarkers.PlayerCommentsLoaded} />
        ...
        // This will shortcut the success marker for comments if they are not enabled
        <SuccessMarker name={SuccessMarkers.PlayerCommentsLoaded} />
      )}
    </ReactionsBarWrapper>
  );
