...
const RightPanel: React.FC<{
  ...
  if (hasCreateTabAccess) {
    tabsToShow.push(TAB_LIST.Create);
  }
              ...
              <Tabs isPilledDesign={isMobile ? true : false}>
                {tabsToShow.map(tabName => (
                  <TabWrapper
                    ...
                    rightIcon={
                      tabName === TAB_LIST.Create ? <SvgSparkle /> : undefined
                    }
                  />
                ))}
              </Tabs>
...
const TabWrapper = ({
  ...
  >
    <Tab tabName={tabName} rightIcon={rightIcon} isActive={isActive} />
  </LensTab>
);
