...
export type GetAggPlanUrlAndProductQuery = { __typename: 'Query', planUrl: { __typename: 'AggTokenRefreshError', message: string } | { __typename: 'GenericError', message: string } | { __typename: 'GetAGGChangePlanUrlPayload', url: string, isAvailableToUser: boolean, isCollection: boolean } | { __typename: 'InputValidationError' } | { __typename: 'UserNotAuthorizedError' } | null, entitlements: { __typename: 'AggTokenRefreshError', message: string } | { __typename: 'GenericError', message: string } | { __typename: 'GetWorkspaceAGGEntitlementsPayload', entitlements: Array<{ __typename: 'Entitlement', currentLoomProductLevel: number } | null> } | { __typename: 'InputValidationError' } | { __typename: 'UserNotAuthorizedError' } | null };
