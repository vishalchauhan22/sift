...
const FTUX_NOTIFICATIONS = {
  ...
  [UserPropertyEnum.PURPLE_TO_BLUE_FTUX]: {
    priority: 1,
    expires: Date.UTC(2025, 11, 10),
    // TODO Maija: 10th November 2025 is 1 month out from the 10th October 2025 TENTATIVE launch date
    team: Team.Acquisition,
    skipCleanupReminder: false
  },
  [UserPropertyEnum.GENERATE_TAB_FTUX]: {
    priority: 0,
    team: Team.AsyncWorkflows,
    skipCleanupReminder: true
  }
};
