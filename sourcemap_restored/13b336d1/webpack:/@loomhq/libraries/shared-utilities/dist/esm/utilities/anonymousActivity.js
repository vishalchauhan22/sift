...
const _getAnonRedirectParams = (anonData) => {
  ...
  return {
    callbackKey: redirectData.callbackKey,
    videoId: redirectData.videoId,
    gate: redirectData.gate,
    asgSource: redirectData.asgSource,
    onboardingType: redirectData.onboardingType
  };
};
